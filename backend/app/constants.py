...
CONSTRUCT_CARDS = [
    ...
    {"id": 16, "name": "Nexus Spire", "tier": "large", "vp": 7,
     "cost": {"fire": 2, "water": 2, "earth": 2, "void": 1},
...
CONTRACT_CARDS = [
    ...
    {"id": "universal_explorer", "name": "Universal Explorer", "vp": 8, "icon": "🧭",
     "requirement": "Discover all 5 Portal types (1 Explorer per type)"},
    ...
    {"id": "ember_lord", "name": "Fire Lord", "vp": 4, "icon": "🔥",
     "requirement": "Harvest from 3+ different Fire Portal cards"},
    {"id": "tide_lord", "name": "Water Lord", "vp": 4, "icon": "💧",
     "requirement": "Harvest from 3+ different Water Portal cards"},
